#ifndef WASMNIX_INCLUDE_NIX_KERNEL_HOST_HPP_
#define WASMNIX_INCLUDE_NIX_KERNEL_HOST_HPP_

// In-module Linux kernel hop — ntoskrnl / WDK analog.
...
#endif  // WASMNIX_INCLUDE_NIX_KERNEL_HOST_HPP_
